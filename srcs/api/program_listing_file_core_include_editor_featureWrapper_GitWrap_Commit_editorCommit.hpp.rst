...
.. _program_listing_file_core_include_editor_featureWrapper_GitWrap_Commit_editorCommit.hpp:

Program Listing for File editorCommit.hpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_editor_featureWrapper_GitWrap_Commit_editorCommit.hpp>` (``core_include\editor\featureWrapper\GitWrap\Commit\editorCommit.hpp``)
