...
.. _program_listing_file_include_input_trashbin_host_linux_ipc_Send_Linux.cpp:

Program Listing for File ipc_Send_Linux.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_input_trashbin_host_linux_ipc_Send_Linux.cpp>` (``include/input/trashbin/host_linux/ipc_Send_Linux.cpp``)
