...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_MainObjects_audioPlayer_audioCallbacks.hpp:

Program Listing for File audioCallbacks.hpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_MainObjects_audioPlayer_audioCallbacks.hpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/core/MainObjects/audioPlayer/audioCallbacks.hpp``)
