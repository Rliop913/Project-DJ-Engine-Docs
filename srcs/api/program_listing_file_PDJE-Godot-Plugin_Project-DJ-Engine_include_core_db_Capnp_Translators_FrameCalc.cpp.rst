...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_db_Capnp_Translators_FrameCalc.cpp:

Program Listing for File FrameCalc.cpp
======================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_db_Capnp_Translators_FrameCalc.cpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/core/db/Capnp/Translators/FrameCalc.cpp``)
...
.. code-block:: cpp
   ...
   {
       double FA = APPRX(double,
                         first.beat,
                         first.subBeat,
                         (first.separate == 0 ? 1 : first.separate));
       double SA = APPRX(double,
                         second.beat,
                         second.subBeat,
                         (second.separate == 0 ? 1 : second.separate));
       return FA < SA;
   }
