...
.. _program_listing_file_include_core_editor_featureWrapper_GitWrap_Branch_editorBranch.hpp:

Program Listing for File editorBranch.hpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_featureWrapper_GitWrap_Branch_editorBranch.hpp>` (``include/core/editor/featureWrapper/GitWrap/Branch/editorBranch.hpp``)
