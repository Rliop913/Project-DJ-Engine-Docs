...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_editor_TimeLine_GitDataPack_GitDatas.hpp:

Program Listing for File GitDatas.hpp
=====================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_editor_TimeLine_GitDataPack_GitDatas.hpp>` (``PDJE-Godot-Plugin\Project-DJ-Engine\include\core\editor\TimeLine\GitDataPack\GitDatas.hpp``)
