...
.. _program_listing_file_include_core_editor_featureWrapper_GitWrap_Diff_DiffController.hpp:

Program Listing for File DiffController.hpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_featureWrapper_GitWrap_Diff_DiffController.hpp>` (``include/core/editor/featureWrapper/GitWrap/Diff/DiffController.hpp``)
