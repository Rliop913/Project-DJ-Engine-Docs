...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_db_musicDB.hpp:

Program Listing for File musicDB.hpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_db_musicDB.hpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/core/db/musicDB.hpp``)
