...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Branch_editorBranch.cpp:

Program Listing for File editorBranch.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Branch_editorBranch.cpp>` (``include/core/editor/DEPRECATE/GitWrap/Branch/editorBranch.cpp``)
