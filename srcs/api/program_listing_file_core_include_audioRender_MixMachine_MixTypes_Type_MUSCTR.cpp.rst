...
.. _program_listing_file_core_include_audioRender_MixMachine_MixTypes_Type_MUSCTR.cpp:

Program Listing for File Type_MUSCTR.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_audioRender_MixMachine_MixTypes_Type_MUSCTR.cpp>` (``core_include\audioRender\MixMachine\MixTypes\Type_MUSCTR.cpp``)
