...
.. _file_include_core_audioRender_MixMachine_MixTypes_Type_FX_COMPRESSOR.cpp:
...
Definition (``include\core\audioRender\MixMachine\MixTypes\Type_FX_COMPRESSOR.cpp``)
------------------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_audioRender_MixMachine_MixTypes_Type_FX_COMPRESSOR.cpp.rst
