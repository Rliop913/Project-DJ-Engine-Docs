...
.. _file_include_core_editor_featureWrapper_GitWrap_gitWrapper.hpp:
...
Definition (``include/core/editor/featureWrapper/GitWrap/gitWrapper.hpp``)
--------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_editor_featureWrapper_GitWrap_gitWrapper.hpp.rst
...
- ``AddController.hpp`` (:ref:`file_include_core_editor_featureWrapper_GitWrap_Add_AddController.hpp`)

- ``BlameController.hpp`` (:ref:`file_include_core_editor_featureWrapper_GitWrap_Blame_BlameController.hpp`)

- ``DiffController.hpp`` (:ref:`file_include_core_editor_featureWrapper_GitWrap_Diff_DiffController.hpp`)

- ``PDJE_EXPORT_SETTER.hpp`` (:ref:`file_include_global_PDJE_EXPORT_SETTER.hpp`)

- ``editorBranch.hpp`` (:ref:`file_include_core_editor_featureWrapper_GitWrap_Branch_editorBranch.hpp`)
...
- ``gitLog.hpp`` (:ref:`file_include_core_editor_featureWrapper_GitWrap_Log_gitLog.hpp`)
