...
.. _file_include_core_MainObjects_editorObject_commonfunction.cpp:
...
Definition (``include\core\MainObjects\editorObject\commonfunction.cpp``)
-------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_MainObjects_editorObject_commonfunction.cpp.rst
