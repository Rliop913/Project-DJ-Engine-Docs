...
.. _file_include_MainObjects_editorObject_undo.cpp:
...
Definition (``include/MainObjects/editorObject/undo.cpp``)
----------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_MainObjects_editorObject_undo.cpp.rst
