...
.. _program_listing_file_core_include_editor_featureWrapper_GitWrap_Log_gitLog.cpp:

Program Listing for File gitLog.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_editor_featureWrapper_GitWrap_Log_gitLog.cpp>` (``core_include\editor\featureWrapper\GitWrap\Log\gitLog.cpp``)
