...
.. _program_listing_file_include_input_trashbin_--DEPRECATED-linux_socket_linux_socket.hpp:

Program Listing for File linux_socket.hpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_input_trashbin_--DEPRECATED-linux_socket_linux_socket.hpp>` (``include/input/trashbin/--DEPRECATED-linux/socket/linux_socket.hpp``)
