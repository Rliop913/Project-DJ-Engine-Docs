...
.. _program_listing_file_core_include_interface_PDJE_interface.hpp:

Program Listing for File PDJE_interface.hpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_interface_PDJE_interface.hpp>` (``core_include\interface\PDJE_interface.hpp``)
