...
.. _file_include_core_MainObjects_editorObject_deleteline.cpp:
...
Definition (``include\core\MainObjects\editorObject\deleteline.cpp``)
---------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_MainObjects_editorObject_deleteline.cpp.rst
