...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Log_gitLog.hpp:

Program Listing for File gitLog.hpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Log_gitLog.hpp>` (``include/core/editor/DEPRECATE/GitWrap/Log/gitLog.hpp``)
