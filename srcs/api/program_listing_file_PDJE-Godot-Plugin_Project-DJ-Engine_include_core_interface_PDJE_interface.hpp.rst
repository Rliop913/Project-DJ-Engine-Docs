...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_interface_PDJE_interface.hpp:

Program Listing for File PDJE_interface.hpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_interface_PDJE_interface.hpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/core/interface/PDJE_interface.hpp``)
