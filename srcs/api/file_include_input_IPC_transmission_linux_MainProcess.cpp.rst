...
.. _file_include_input_IPC_transmission_linux_MainProcess.cpp:

File MainProcess.cpp
====================

|exhale_lsh| :ref:`Parent directory <dir_include_input_IPC_transmission_linux>` (``include/input/IPC/transmission/linux``)
...
Definition (``include/input/IPC/transmission/linux/MainProcess.cpp``)
---------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_input_IPC_transmission_linux_MainProcess.cpp.rst
