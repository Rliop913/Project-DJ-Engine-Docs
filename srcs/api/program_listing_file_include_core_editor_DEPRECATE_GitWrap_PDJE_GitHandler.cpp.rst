...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_PDJE_GitHandler.cpp:

Program Listing for File PDJE_GitHandler.cpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_PDJE_GitHandler.cpp>` (``include/core/editor/DEPRECATE/GitWrap/PDJE_GitHandler.cpp``)
