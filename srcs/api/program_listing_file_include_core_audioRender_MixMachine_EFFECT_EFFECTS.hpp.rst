...
.. _program_listing_file_include_core_audioRender_MixMachine_EFFECT_EFFECTS.hpp:

Program Listing for File EFFECTS.hpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_audioRender_MixMachine_EFFECT_EFFECTS.hpp>` (``include\core\audioRender\MixMachine\EFFECT\EFFECTS.hpp``)
