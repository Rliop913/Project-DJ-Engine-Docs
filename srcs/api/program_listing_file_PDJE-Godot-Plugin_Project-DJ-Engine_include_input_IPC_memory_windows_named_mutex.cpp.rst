...
|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_input_IPC_memory_windows_named_mutex.cpp>` (``PDJE-Godot-Plugin\Project-DJ-Engine\include\input\IPC\memory\windows\named_mutex.cpp``)
