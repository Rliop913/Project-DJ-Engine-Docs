...
.. _file_core_include_audioRender_MixMachine_MixMachine.hpp:
...
Definition (``core_include\audioRender\MixMachine\MixMachine.hpp``)
-------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_core_include_audioRender_MixMachine_MixMachine.hpp.rst
...
- ``BattleDj.hpp`` (:ref:`file_core_include_audioRender_MixMachine_MUSIC_CTR_BattleDj.hpp`)

- ``Decoder.hpp`` (:ref:`file_core_include_audioRender_MixMachine_MiniaudioObjects_Decoder.hpp`)

- ``EFFECTS.hpp`` (:ref:`file_core_include_audioRender_MixMachine_EFFECT_EFFECTS.hpp`)
...
- :ref:`file_core_include_audioRender_MixMachine_MixMachine.cpp`
