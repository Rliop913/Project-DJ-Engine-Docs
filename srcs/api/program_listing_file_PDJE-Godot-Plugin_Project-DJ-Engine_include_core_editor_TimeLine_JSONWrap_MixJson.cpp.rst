...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_editor_TimeLine_JSONWrap_MixJson.cpp:

Program Listing for File MixJson.cpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_editor_TimeLine_JSONWrap_MixJson.cpp>` (``PDJE-Godot-Plugin\Project-DJ-Engine\include\core\editor\TimeLine\JSONWrap\MixJson.cpp``)
...
.. code-block:: cpp
   ...
   template <>
   bool
   PDJE_JSONHandler<MIX_W>::load(const fs::path &filepath)
   {
