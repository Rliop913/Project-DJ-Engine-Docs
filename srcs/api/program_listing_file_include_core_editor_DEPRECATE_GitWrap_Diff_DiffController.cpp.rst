...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Diff_DiffController.cpp:

Program Listing for File DiffController.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Diff_DiffController.cpp>` (``include/core/editor/DEPRECATE/GitWrap/Diff/DiffController.cpp``)
