...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_FAKE_CAPNP_ENUMS_FOR_SWIG.hpp:

Program Listing for File FAKE_CAPNP_ENUMS_FOR_SWIG.hpp
======================================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_FAKE_CAPNP_ENUMS_FOR_SWIG.hpp>` (``PDJE-Godot-Plugin\Project-DJ-Engine\include\core\FAKE_CAPNP_ENUMS_FOR_SWIG.hpp``)
