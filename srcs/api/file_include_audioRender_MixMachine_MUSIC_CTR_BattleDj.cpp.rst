...
.. _file_include_audioRender_MixMachine_MUSIC_CTR_BattleDj.cpp:
...
Definition (``include/audioRender/MixMachine/MUSIC_CTR/BattleDj.cpp``)
----------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_audioRender_MixMachine_MUSIC_CTR_BattleDj.cpp.rst
