...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_interface_CPDJE_interface.h:

Program Listing for File CPDJE_interface.h
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_interface_CPDJE_interface.h>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/core/interface/CPDJE_interface.h``)
