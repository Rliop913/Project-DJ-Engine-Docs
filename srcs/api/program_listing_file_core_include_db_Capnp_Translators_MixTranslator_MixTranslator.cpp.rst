...
.. _program_listing_file_core_include_db_Capnp_Translators_MixTranslator_MixTranslator.cpp:

Program Listing for File MixTranslator.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_db_Capnp_Translators_MixTranslator_MixTranslator.cpp>` (``core_include\db\Capnp\Translators\MixTranslator\MixTranslator.cpp``)
