...
.. _program_listing_file_core_include_editor_featureWrapper_GitWrap_Add_AddController.cpp:

Program Listing for File AddController.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_editor_featureWrapper_GitWrap_Add_AddController.cpp>` (``core_include\editor\featureWrapper\GitWrap\Add\AddController.cpp``)
