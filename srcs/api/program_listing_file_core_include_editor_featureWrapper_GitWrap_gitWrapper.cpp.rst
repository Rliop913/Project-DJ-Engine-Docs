...
.. _program_listing_file_core_include_editor_featureWrapper_GitWrap_gitWrapper.cpp:

Program Listing for File gitWrapper.cpp
=======================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_editor_featureWrapper_GitWrap_gitWrapper.cpp>` (``core_include\editor\featureWrapper\GitWrap\gitWrapper.cpp``)
