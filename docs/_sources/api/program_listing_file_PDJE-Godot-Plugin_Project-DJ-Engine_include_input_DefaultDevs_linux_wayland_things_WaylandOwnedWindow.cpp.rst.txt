...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_input_DefaultDevs_linux_wayland_things_WaylandOwnedWindow.cpp:

Program Listing for File WaylandOwnedWindow.cpp
===============================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_input_DefaultDevs_linux_wayland_things_WaylandOwnedWindow.cpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/input/DefaultDevs/linux/wayland_things/WaylandOwnedWindow.cpp``)
