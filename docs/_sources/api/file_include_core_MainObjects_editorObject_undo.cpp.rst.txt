...
.. _file_include_core_MainObjects_editorObject_undo.cpp:
...
Definition (``include\core\MainObjects\editorObject\undo.cpp``)
---------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_MainObjects_editorObject_undo.cpp.rst
