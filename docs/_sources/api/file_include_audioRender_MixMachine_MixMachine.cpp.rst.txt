...
.. _file_include_audioRender_MixMachine_MixMachine.cpp:
...
Definition (``include/audioRender/MixMachine/MixMachine.cpp``)
--------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_audioRender_MixMachine_MixMachine.cpp.rst
