...
.. _file_core_include_editor_featureWrapper_GitWrap_gitWrapper.hpp:
...
Definition (``core_include\editor\featureWrapper\GitWrap\gitWrapper.hpp``)
--------------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_core_include_editor_featureWrapper_GitWrap_gitWrapper.hpp.rst
...
- ``AddController.hpp`` (:ref:`file_core_include_editor_featureWrapper_GitWrap_Add_AddController.hpp`)

- ``BlameController.hpp`` (:ref:`file_core_include_editor_featureWrapper_GitWrap_Blame_BlameController.hpp`)

- ``DiffController.hpp`` (:ref:`file_core_include_editor_featureWrapper_GitWrap_Diff_DiffController.hpp`)

- ``PDJE_EXPORT_SETTER.hpp`` (:ref:`file_global_include_PDJE_EXPORT_SETTER.hpp`)

- ``editorBranch.hpp`` (:ref:`file_core_include_editor_featureWrapper_GitWrap_Branch_editorBranch.hpp`)
...
- ``gitLog.hpp`` (:ref:`file_core_include_editor_featureWrapper_GitWrap_Log_gitLog.hpp`)
