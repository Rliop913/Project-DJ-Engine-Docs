...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_judge_Init_PDJE_Judge_Init.hpp:

Program Listing for File PDJE_Judge_Init.hpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_judge_Init_PDJE_Judge_Init.hpp>` (``PDJE-Godot-Plugin\Project-DJ-Engine\include\judge\Init\PDJE_Judge_Init.hpp``)
