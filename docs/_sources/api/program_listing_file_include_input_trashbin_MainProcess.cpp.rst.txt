...
.. _program_listing_file_include_input_trashbin_MainProcess.cpp:

Program Listing for File MainProcess.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_input_trashbin_MainProcess.cpp>` (``include/input/trashbin/MainProcess.cpp``)
