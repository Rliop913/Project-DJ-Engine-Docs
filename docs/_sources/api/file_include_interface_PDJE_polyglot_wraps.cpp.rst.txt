...
.. _file_include_interface_PDJE_polyglot_wraps.cpp:
...
Definition (``include/interface/PDJE_polyglot_wraps.cpp``)
----------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_interface_PDJE_polyglot_wraps.cpp.rst
