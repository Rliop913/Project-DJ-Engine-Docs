...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_global_PDJE_LOG_SETTER.cpp:

Program Listing for File PDJE_LOG_SETTER.cpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_global_PDJE_LOG_SETTER.cpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/global/PDJE_LOG_SETTER.cpp``)
