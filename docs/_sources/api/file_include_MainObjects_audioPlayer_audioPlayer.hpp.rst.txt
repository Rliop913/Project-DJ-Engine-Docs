...
.. _file_include_MainObjects_audioPlayer_audioPlayer.hpp:
...
Definition (``include/MainObjects/audioPlayer/audioPlayer.hpp``)
----------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_MainObjects_audioPlayer_audioPlayer.hpp.rst
