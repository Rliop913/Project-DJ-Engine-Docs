...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_util_db_nearest_BackendConcept.hpp:

Program Listing for File BackendConcept.hpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_util_db_nearest_BackendConcept.hpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/util/db/nearest/BackendConcept.hpp``)
