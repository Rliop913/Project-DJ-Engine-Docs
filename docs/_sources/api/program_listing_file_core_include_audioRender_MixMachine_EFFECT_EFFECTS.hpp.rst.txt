...
.. _program_listing_file_core_include_audioRender_MixMachine_EFFECT_EFFECTS.hpp:

Program Listing for File EFFECTS.hpp
====================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_audioRender_MixMachine_EFFECT_EFFECTS.hpp>` (``core_include\audioRender\MixMachine\EFFECT\EFFECTS.hpp``)
