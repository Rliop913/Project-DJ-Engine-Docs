...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_interface_PDJE_interface.cpp:

Program Listing for File PDJE_interface.cpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_interface_PDJE_interface.cpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/core/interface/PDJE_interface.cpp``)
