...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_judge_CPDJE_Judge.cpp:

Program Listing for File CPDJE_Judge.cpp
========================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_judge_CPDJE_Judge.cpp>` (``PDJE-Godot-Plugin/Project-DJ-Engine/include/judge/CPDJE_Judge.cpp``)
