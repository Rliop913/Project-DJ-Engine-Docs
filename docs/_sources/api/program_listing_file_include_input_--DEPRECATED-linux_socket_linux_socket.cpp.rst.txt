...
.. _program_listing_file_include_input_--DEPRECATED-linux_socket_linux_socket.cpp:

Program Listing for File linux_socket.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_input_--DEPRECATED-linux_socket_linux_socket.cpp>` (``include\input\--DEPRECATED-linux\socket\linux_socket.cpp``)
