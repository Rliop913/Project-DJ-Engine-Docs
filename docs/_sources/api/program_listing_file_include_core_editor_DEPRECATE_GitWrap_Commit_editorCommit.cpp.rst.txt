...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Commit_editorCommit.cpp:

Program Listing for File editorCommit.cpp
=========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Commit_editorCommit.cpp>` (``include/core/editor/DEPRECATE/GitWrap/Commit/editorCommit.cpp``)
