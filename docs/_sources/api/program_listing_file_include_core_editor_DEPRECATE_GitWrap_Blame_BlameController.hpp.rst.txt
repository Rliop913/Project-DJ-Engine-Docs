...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Blame_BlameController.hpp:

Program Listing for File BlameController.hpp
============================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Blame_BlameController.hpp>` (``include/core/editor/DEPRECATE/GitWrap/Blame/BlameController.hpp``)
