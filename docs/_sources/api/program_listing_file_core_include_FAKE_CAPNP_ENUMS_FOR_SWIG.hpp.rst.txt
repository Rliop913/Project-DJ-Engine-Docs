...
.. _program_listing_file_core_include_FAKE_CAPNP_ENUMS_FOR_SWIG.hpp:

Program Listing for File FAKE_CAPNP_ENUMS_FOR_SWIG.hpp
======================================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_FAKE_CAPNP_ENUMS_FOR_SWIG.hpp>` (``core_include\FAKE_CAPNP_ENUMS_FOR_SWIG.hpp``)
