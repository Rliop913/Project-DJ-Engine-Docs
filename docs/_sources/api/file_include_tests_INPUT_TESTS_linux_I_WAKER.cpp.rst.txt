...
.. _file_include_tests_INPUT_TESTS_linux_I_WAKER.cpp:

File linux_I_WAKER.cpp
======================
...
Definition (``include\tests\INPUT_TESTS\linux_I_WAKER.cpp``)
------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_tests_INPUT_TESTS_linux_I_WAKER.cpp.rst
