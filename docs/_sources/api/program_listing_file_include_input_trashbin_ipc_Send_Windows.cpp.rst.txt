...
.. _program_listing_file_include_input_trashbin_ipc_Send_Windows.cpp:

Program Listing for File ipc_Send_Windows.cpp
=============================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_input_trashbin_ipc_Send_Windows.cpp>` (``include/input/trashbin/ipc_Send_Windows.cpp``)
