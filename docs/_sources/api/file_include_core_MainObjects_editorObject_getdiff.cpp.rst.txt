...
.. _file_include_core_MainObjects_editorObject_getdiff.cpp:
...
Definition (``include\core\MainObjects\editorObject\getdiff.cpp``)
------------------------------------------------------------------
...
.. toctree::
   ...
   program_listing_file_include_core_MainObjects_editorObject_getdiff.cpp.rst
