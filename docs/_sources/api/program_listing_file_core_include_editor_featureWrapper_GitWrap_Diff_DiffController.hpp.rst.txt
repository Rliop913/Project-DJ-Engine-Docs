...
.. _program_listing_file_core_include_editor_featureWrapper_GitWrap_Diff_DiffController.hpp:

Program Listing for File DiffController.hpp
===========================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_editor_featureWrapper_GitWrap_Diff_DiffController.hpp>` (``core_include\editor\featureWrapper\GitWrap\Diff\DiffController.hpp``)
