...
.. _program_listing_file_core_include_input_linux_LINUX_SUDO_GETTER.cpp:

Program Listing for File LINUX_SUDO_GETTER.cpp
==============================================

|exhale_lsh| :ref:`Return to documentation for file <file_core_include_input_linux_LINUX_SUDO_GETTER.cpp>` (``core_include\input\linux\LINUX_SUDO_GETTER.cpp``)
