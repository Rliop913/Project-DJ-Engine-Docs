...
.. _program_listing_file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_editor_TimeLine_DiffMachine_TimeLineDiffMachine-MUSIC.cpp:

Program Listing for File TimeLineDiffMachine-MUSIC.cpp
======================================================

|exhale_lsh| :ref:`Return to documentation for file <file_PDJE-Godot-Plugin_Project-DJ-Engine_include_core_editor_TimeLine_DiffMachine_TimeLineDiffMachine-MUSIC.cpp>` (``PDJE-Godot-Plugin\Project-DJ-Engine\include\core\editor\TimeLine\DiffMachine\TimeLineDiffMachine-MUSIC.cpp``)
