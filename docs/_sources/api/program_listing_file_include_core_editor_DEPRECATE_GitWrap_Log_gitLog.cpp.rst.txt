...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Log_gitLog.cpp:

Program Listing for File gitLog.cpp
===================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Log_gitLog.cpp>` (``include/core/editor/DEPRECATE/GitWrap/Log/gitLog.cpp``)
