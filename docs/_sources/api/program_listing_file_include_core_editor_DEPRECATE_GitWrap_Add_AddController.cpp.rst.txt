...
.. _program_listing_file_include_core_editor_DEPRECATE_GitWrap_Add_AddController.cpp:

Program Listing for File AddController.cpp
==========================================

|exhale_lsh| :ref:`Return to documentation for file <file_include_core_editor_DEPRECATE_GitWrap_Add_AddController.cpp>` (``include/core/editor/DEPRECATE/GitWrap/Add/AddController.cpp``)
