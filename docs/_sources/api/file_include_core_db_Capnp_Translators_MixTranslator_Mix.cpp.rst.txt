...
.. _file_include_core_db_Capnp_Translators_MixTranslator_Mix.cpp:
...
.. toctree::
   ...
   program_listing_file_include_core_db_Capnp_Translators_MixTranslator_Mix.cpp.rst
...
- ``Bpm.hpp`` (:ref:`file_include_core_db_Capnp_Translators_MixTranslator_Bpm.hpp`)

- ``Mix.hpp`` (:ref:`file_include_core_audioRender_ManualMix_ManualMix.hpp`)
